...
export default class extends Parent {
    ...
    create(data, params, headers) {
        return super.post(`/users`, params, data, headers);
    }
     ...
     * @returns {Object} Promise
     */
    update(userId, data, params, headers) {
        super.requiredInput('$wpApiUsers:update', {
            userId
        });
        return super.post(`/users/{$userId}`, params, data, headers);
    }
     ...
     * @returns {Object} Promise
     */
    delete(userId, data, params, headers) {
        super.requiredInput('$wpApiUsers:delete', {
            userId
        });
        return super.delete(`/users/{$userId}`, data, params, headers);
    }
